...
It is easier to understand if we tried to grasp what the code does in general and then the specifics. The code starts by including libraries, it has 1 function called main. 
